...
- For each section in the roadmap, check for: `spec.section.yml` (with optional `screen` key), `data.yml`, `screenshots.md`
...
- `spec.section.yml` — Section overview with screen designs (under `screen` key)
