# Pendrop Stories - Sub-Skills

This folder contains the individual sub-skills that make up the story generation pipeline. Each skill represents a specific step in the process.
...
9. **split-manifest.md** - Converts manifest to YAML files
