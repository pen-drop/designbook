...
description: Validates and normalizes the component name parameter for story generation
---
...
## Purpose
Validates the component name parameter before story generation begins.
...
1. **Check if component name is provided**
   ...
   - Ask: "Please provide the component name for story generation (e.g., Button, Card, Hero)"
