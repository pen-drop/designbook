...
/**
 * StepIndicator - Displays a step in a multi-step workflow with
 ...
 */
export function StepIndicator({ step, title, status, children, isLast = false }) {
  return (
...
/**
 * StepIndicatorGroup - Renders multiple steps together with proper spacing.
 *
 * @param {Object} props
 * @param {Array} props.steps - Array of { step, title, status, content }
 */
export function StepIndicatorGroup({ steps }) {
  return (
