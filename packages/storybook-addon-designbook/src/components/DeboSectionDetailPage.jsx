...
import { DeboStepIndicator } from './DeboStepIndicator.jsx';
import { DeboSectionSpecCard } from './DeboSectionSpecCard.jsx';
import { DeboSampleDataCard } from './DeboSampleDataCard.jsx';
...
export function DeboSectionDetailPage({ sectionId, title }) {
  ...
  return (
    <div className="debo:font-sans debo:max-w-2xl debo:mx-auto debo:py-6 debo:space-y-8">
      ...
      <DeboStepIndicator step={1} title="Section Specification" status={statuses[0]}>
        {spec ? (
          <DeboSectionSpecCard spec={{ ...spec, title: spec.title || title }} />
        ) : (
          <DeboEmptyState
      ...
      {/* Step 2: Sample Data */}
      <DeboStepIndicator step={2} title="Sample Data" status={statuses[1]}>
        {data ? (
          <DeboSampleDataCard data={data} />
        ) : (
          <DeboEmptyState
      ...
      <DeboStepIndicator step={3} title="Screen Designs" status={statuses[2]}>
      ...
      {/* Step 4: Screenshots */}
      <DeboStepIndicator step={4} title="Screenshots" status={statuses[3]} isLast>
