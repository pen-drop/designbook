...
The system SHALL provide a ProductOverviewCard React component that displays a summary of the defined product vision including name, description, problems/solutions, and key features.

#### Scenario: Card displays product information
- **WHEN** ProductOverviewCard is rendered with product data
- **THEN** it displays the product name as the card title
...
- **THEN** it displays problems and solutions in an organized, expandable format
...
- **THEN** it displays the list of key features
