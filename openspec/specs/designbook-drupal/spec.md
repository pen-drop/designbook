...
Defines the consolidated Drupal/SDC skill root structure. All Drupal-backend and SDC-framework content is organized under a single skill root at `.agents/skills/designbook-drupal/` with four sub-directories.
