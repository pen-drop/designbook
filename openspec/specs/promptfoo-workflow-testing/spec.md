...
- **THEN** the rubric SHALL verify `design-system/design-system.scenes.yml` was created with a `shell` scene containing page/header/footer component composition, navigation items mapped to sections, layout pattern, and responsive behavior
