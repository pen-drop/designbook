# workflow-parallel-execution Specification

## Purpose
Defines DAG-based parallel task execution via isolated subagents, replacing sequential in-process execution for non-intake workflow stages.
