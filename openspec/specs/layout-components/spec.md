...
The system SHALL provide a `container` component that constrains content width, provides horizontal browser-edge padding (padding-inline), and provides structural framing.
...
The system SHALL provide a `grid` component that arranges items in responsive column layouts.
...
The system SHALL provide a `section` component that combines container + grid with 8 fixed column slots for Layout Builder.
