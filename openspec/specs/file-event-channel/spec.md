# file-event-channel Specification

## Purpose
Defines requirements for typed file-change events broadcast over the Storybook WebSocket channel, replacing the SSE endpoint approach for notifying the panel of file changes.
