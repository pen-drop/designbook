...
description: "Internal skill — generates Twig templates from Figma story screenshots using AI-assisted visual analysis. Invoked by debo-figma-twig workflow only."
---
...
> **Internal skill** — Do not invoke directly. Use the `debo-figma-twig` workflow instead.
