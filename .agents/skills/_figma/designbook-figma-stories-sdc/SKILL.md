...
description: "Internal skill — generates Drupal SDC story YAML files from Figma data. Invoked by debo-figma-stories workflow only."
---
...
> **Internal skill** — Do not invoke directly. Use the `debo-figma-stories` workflow instead.
...
!WORKFLOW_FILE create-story: components/{component-name}/{component-name}.default.story.yml
