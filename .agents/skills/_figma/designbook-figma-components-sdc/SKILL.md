...
description: "Internal skill — generates Drupal SDC component YAML files from Figma data. Invoked by debo-figma-components workflow only."
---
...
> **Internal skill** — Do not invoke directly. Use the `debo-figma-components` workflow instead.
...
!WORKFLOW_FILE create-component: components/{component-name}/{component-name}.component.yml
