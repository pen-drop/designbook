...
description: Domain decisions required before planning design-screen artifacts.
---

# design-screen intake

Identify the section, scene/story and reference. Inspect the complete reference and existing shell/component inventory. Decide all layout regions, component IDs, variants, entity mappings, sample-data bundles and responsive breakpoints. Enumerate every component, mapping and scene output before planning.
