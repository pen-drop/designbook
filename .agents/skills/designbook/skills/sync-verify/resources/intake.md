...
1. Use the saved intake context's backend integration and subject-mapping
...
3. Follow the [shared capture intake](../../extract-reference/resources/intake.md)
   ...
   revision and common observed-data outputs through `plan done`.
...
5. Build the fixed `sync-verify` plan from `compare-observations`,
...
comparison plan rather than changing the bound evidence.
