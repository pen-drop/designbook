---
name: import-intake
description: Domain decisions required before planning import artifacts.
---

# import intake

Inspect the whole reference. Enumerate the product vision, tokens, entities/bundles, sections, shell, components and scenes in scope. Resolve ordering and prerequisites. Build a complete combined workflow or fully plan each subsequent workflow before starting it; complete structural reference analysis here.
