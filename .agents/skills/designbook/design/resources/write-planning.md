...
2. For a supplied visual reference, follow [reference intake](reference-intake.md) and finish analysis and asset selection during intake and embed the measurements. For text-only requests, embed concrete appearance, behavior and responsive criteria plus retained structure. Completion: execution needs no new reference, asset or structural selection.
