...
$defs:
  ...
  ComponentNode:
    ...
    properties:
      component:
        type: string
        description: "provider:component-name format (e.g. $DESIGNBOOK_COMPONENT_NAMESPACE:card)"
      props:
        type: object
...
properties:
  component:
    type: string
    description: "provider:component-name (e.g. $DESIGNBOOK_COMPONENT_NAMESPACE:heading)"
  props:
    type: object
  slots:
    type: object
