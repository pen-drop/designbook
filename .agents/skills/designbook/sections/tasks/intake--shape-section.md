...
Help the user define a specification for one roadmap section. The result feeds the `create-section` stage and is saved to `${DESIGNBOOK_OUTPUTS_CONFIG}/sections/[section-id]/[section-id].section.scenes.yml`.

## Step 1: Select Section

Parse the sections from the product vision. Check which sections already have specs at `${DESIGNBOOK_OUTPUTS_CONFIG}/sections/[section-id]/*.section.scenes.yml`.
