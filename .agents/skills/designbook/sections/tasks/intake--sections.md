...
Each approved section becomes a separate item with stage `sections:create-section`:
```json
[
  {"stage": "sections:create-section", "params": {"section_id": "dashboard", "section_title": "Dashboard", "description": "...", "order": 1}},
  {"stage": "sections:create-section", "params": {"section_id": "training", "section_title": "Training", "description": "...", "order": 2}}
]
```
