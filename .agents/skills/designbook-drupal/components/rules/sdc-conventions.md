...
Shell components (header, footer, page) are full UI components with real HTML, not structural slot-only wrappers. Same location (`$DESIGNBOOK_DIRS_ROOT/components/`), same provider as all other UI components.
