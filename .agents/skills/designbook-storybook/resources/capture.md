...
description: Assemble a source capture using the integration's observed-data instructions.
---

Follow the [shared capture intake](../../designbook/skills/capture-reference/resources/intake.md).
