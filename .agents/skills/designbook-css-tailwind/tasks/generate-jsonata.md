...
`$DESIGNBOOK_DIST/designbook-css-tailwind/generate-grid.jsonata`:
...
`$DESIGNBOOK_DIST/designbook-css-tailwind/generate-color.jsonata`:
...
`$DESIGNBOOK_DIST/designbook-css-tailwind/generate-radius.jsonata`:
...
`$DESIGNBOOK_DIST/designbook-css-tailwind/generate-shadow.jsonata`:
