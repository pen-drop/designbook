...
files:
  ...
  - $DESIGNBOOK_DATA/designbook-css-tailwind/generate-google-fonts.jsonata
---
...
`$DESIGNBOOK_DATA/designbook-css-tailwind/generate-grid.jsonata`:
...
`$DESIGNBOOK_DATA/designbook-css-tailwind/generate-color.jsonata`:
...
`$DESIGNBOOK_DATA/designbook-css-tailwind/generate-radius.jsonata`:
...
`$DESIGNBOOK_DATA/designbook-css-tailwind/generate-shadow.jsonata`:
