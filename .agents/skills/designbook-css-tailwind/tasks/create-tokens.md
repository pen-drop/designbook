...
Writes the approved design tokens to `$DESIGNBOOK_DATA/design-system/design-tokens.yml` in W3C Design Token YAML format with Tailwind-specific naming conventions.
