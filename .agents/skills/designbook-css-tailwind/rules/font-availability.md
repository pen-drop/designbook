...
Before a component emits any `font-*` utility (e.g. a token-backed `font-heading`, `font-body`, or another named font utility):
...
for the plan, and continue other tasks — never mark the check passed via a
